...
This guide helps you quickly set up the development environment and run MCP Studio.

## What is MCP Studio?

MCP Studio is a professional MCP (Model Context Protocol) client debugging tool for:
- Connecting and managing MCP servers
- Debugging MCP tool calls
- Monitoring communication processes
- Saving and analyzing call history
